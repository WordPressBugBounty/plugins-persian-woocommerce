...
* گزارشات جامع فروش و درآمد شمسی (برای اولین بار در ایران)
* گزارشات انبار، موجودی و ارزش محصولات
* گزارشات مشتریان فروشگاه و نرخ مشتریان فعال
* گزارشات جامع و اختصاصی شمسی (برای اولین بار در ایران)
...
* افزودن گزارشات مشتریان فروشگاه
* حل مشکل کندی پیشخوان در برخی سایت‌ها
* بهبود ابزار کنترل سرعت سوپر ادمین
* حل مشکل آرشیو تاریخ لیست نوشته‌ها و برگه‌ها
* بهبود سرعت آرشیو تاریخ لیست سفارشات
= 9.3.4 =
* بهبود ابزار نمایش کمترین قیمت محصولات متغیر
= 9.3.3 =
* سازگاری با ووکامرس ۱۰.۳.۵
* حل مشکل قیمت تخفیف خورده محصولات در برخی سایت‌ها
* بهبود تایید تراکنش‌های درگاه زیبال
* افزودن شهر پردیس به استان البرز
* سازگاری با آخرین نسخه قالب وودمارت
= 9.3.2 =
...
* ارسال لیست محصولات به درگاه زیبال
* پشتیبانی درگاه زیبال از ویرایشگر بلوکی
* بهبود سرعت بارگزاری ابزارک پیشخوان
* سازگاری افزونه Yoast SEO با فونت فارسی
* حل هشدار تاریخ شمسی در برخی پیشخوان‌ها
= 9.3.0 =
* افزودن قالب‌های صفحه ورود (جایگزین زیبا برای صفحه ورود وردپرس)
* بروزرسانی درگاه زیبال (تطبیق کارت و موبایل، اتصال از هاست خارج)
* سازگاری واحدهای پولی با افزونه محبوب WP Seo
* حل مشکل عدم نمایش انتخابگر تاریخ در برخی صفحات
* بهبود سرعت و عملکرد سیستم اطلاع‌رسانی
= 9.2.0 =
* بروزرسانی ترجمه
...
= 7.1.3 =
* حل مشکل عدم بارگذاری فایل ترجمه
= 7.1.2 =
* حل مشکل عدم بارگذاری فایل ترجمه
= 7.1.1 =
...
* بهبود بخش شهرهای ایران (به ووکامرس فارسی >> ابزارها مراجعه شود)
